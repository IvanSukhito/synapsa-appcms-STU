    ...
    function listAllMenu()
    {
        return [
            ...
            [
                ...
                'data' => [
                    [
                        'name' => __('general.doctor_clinic_homecare'),
                        'title' => __('general.doctor_clinic_homecare'),
                    ...
                    [
                        'name' => __('general.doctor_clinic_visit'),
                        'title' => __('general.doctor_clinic_visit'),
                    ...
                    [
                        'name' => __('general.doctor_clinic_telemed'),
                        'title' => __('general.doctor_clinic_telemed'),
