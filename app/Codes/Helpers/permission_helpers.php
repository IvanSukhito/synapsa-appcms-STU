        ...
        return [
            ...
            [
                ...
                'active' => [
                    ...
                    'admin.appointment-doctor-homecare.',
                    'admin.appointment-doctor-visit.',
                    'admin.appointment-doctor-telemed.',
                ],
                'type' => 2,
                'data' => [
                    [
                        'name' => __('general.appointment_doctor_homecare'),
                        'title' => __('general.appointment_doctor_homecare'),
                        'active' => ['admin.appointment-doctor-homecare.'],
                        'route' => 'admin.appointment-doctor-homecare.index',
                        'key' => 'appointment-doctor-homecare',
                        'type' => 1,
                    ],
                    [
                        'name' => __('general.appointment_doctor_visit'),
                        'title' => __('general.appointment_doctor_visit'),
                        'active' => ['admin.appointment-doctor-visit.'],
                        'route' => 'admin.appointment-doctor-visit.index',
                        'key' => 'appointment-doctor-visit',
                        'type' => 1,
                    ],
                    [
                        'name' => __('general.appointment_doctor_telemed'),
                        'title' => __('general.appointment_doctor_telemed'),
                        'active' => ['admin.appointment-doctor-telemed.'],
                        'route' => 'admin.appointment-doctor-telemed.index',
                        'key' => 'appointment-doctor-telemed',
                        'type' => 1,
                    ],
                ],
            ],
