    ...
    function listAllMenu()
    {
        return [
            ...
            [
                ...
                'data' => [
                    [
                        'name' => __('general.doctor-clinic-homecare'),
                        'title' => __('general.doctor-clinic-homecare'),
                    ...
                    [
                        'name' => __('general.doctor-clinic-visit'),
                        'title' => __('general.doctor-clinic-visit'),
                    ...
                    [
                        'name' => __('general.doctor-clinic-telemed'),
                        'title' => __('general.doctor-clinic-telemed'),
