...
class AppointmentLabVisitController extends _CrudController
{
    public function __construct(Request $request)
    {
        ...
        parent::__construct(
            $request, 'general.appointment_lab_visit', 'appointment-lab-visit', 'V1\AppointmentLab', 'appointment-lab-visit',
            $passingData
        );
