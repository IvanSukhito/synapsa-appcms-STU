            ...
            <div class="card {!! $printCard !!}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="example_import_product">{{ __('general.example_import_product') }} <span class="text-red">*</span></label><br />
                        <a href="?download_example_import=1"
                           class="btn btn-sm btn-primary" title="{{ __('general.download') }}" id="example_import_product">
                            <i class="fa fa-file-excel-o"></i><span class=""> {{ __('general.download') }}</span>
                        </a>
                    </div>

                    <div class="form-group">
                        <label for="import_product">{{ __('general.import_product') }} <span class="text-red">*</span></label>
                        {{ Form::file('import_product', ['class' => $errors->has('import_product') ? 'form-control dropify is-invalid' : 'form-control dropify', 'id' => 'import_product', 'required' => true, 'autocomplete' => 'off', 'accept' => '.xls, .xlsx']) }}
                    </div>
                </div>
                <!-- /.card-body -->
