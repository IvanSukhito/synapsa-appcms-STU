                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped" id="data1">
                                ...
                                <tr>
                                    ...
                                    <th>@lang('general.doctor_category')</th>
                                ...
                                @foreach($doctor as $list)
                                    <tr>
                                        <td>{{ $list->id }}</td>
                                        <td>{{ $list->fullname }}</td>
                                        <td>{{ $list->klinik_name }}</td>
                                        <td>{{ $list->doctor_category }}</td>
                                        <td>{{ $listSetGender[$list->gender] }}</td>
                                        <td>
                                            <a href="{{ $list->image_full }}" target="_blank" title="{{$list->image_full}}"  data-fancybox>
                                                <img src="{{ $list->image_full }}" class="img-responsive max-image-preview" alt="{{$list->image_full}}"/>
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
