...
@section('script-bottom')
    ...
    <script>
        ...
        $('#type').on('change', function() {
           ...
           let targetMenu = $('#target_menu');
           let targetId = $('#target_id');

           if(type === '1') {
               targetUrl.parent().show();
               targetUrl.prop('required', true);
               targetMenu.parent().hide();
               targetMenu.prop('required', false);
               targetId.parent().hide();
               targetId.prop('required', false);
           }
           else if(type === '2') {
               targetUrl.parent().hide();
               targetUrl.prop('required', false);
               targetMenu.parent().show();
               targetMenu.prop('required', true);
               targetId.parent().hide();
               targetId.prop('required', false);
           }
           else if(type === '3') {
