            ...
            <div class="card {!! $printCard !!}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="example_import_clinic">{{ __('general.example_import_clinic') }} <span class="text-red">*</span></label><br />
                        <a href="?download_example_import=1"
                           class="btn btn-sm btn-primary" title="{{ __('general.download') }}" id="example_import_clinic">
                            <i class="fa fa-file-excel-o"></i><span class=""> {{ __('general.download') }}</span>
                        </a>
                    </div>

                    <div class="form-group">
                        <label for="import_clinic">{{ __('general.import_clinic') }} <span class="text-red">*</span></label>
                        {{ Form::file('import_clinic', ['class' => $errors->has('import_clinic') ? 'form-control dropify is-invalid' : 'form-control dropify', 'id' => 'import_clinic', 'required' => true, 'autocomplete' => 'off', 'accept' => '.xls, .xlsx']) }}
                    </div>
                </div>
                <!-- /.card-body -->
