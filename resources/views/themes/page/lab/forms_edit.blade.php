...
@section('script-bottom')
    ...
    <script>
        ...
        let listLabService = JSON.parse('{!! $labService !!}');
        let attribute = JSON.parse('{!! json_encode($addAttribute) !!}');
        ...
        $(document).ready(function() {
            ...
            $.each(listDataService, function (index, item) {
                ...
                $.each(listLabService, function (index2, item2) {
                    if (parseInt(index) === parseInt(item2.service_id)) {
                        ...
                        html += '<div class="form-group">' +
                            ...
                            '<input type="text" id="price_' + i + '" name="price[' + i + ']" class="form-control setMoney" placeholder="@lang('general.price')" value="' + getPrice + '" @if(in_array($viewType, ['show'])) disabled @endif> ' +
                            '</div>';
                        i++;
                    ...
                    let totalService = listLabService.length;
                    $('#infoService').html('Total' + '&nbsp;' + totalService + '&nbsp;' + 'Service');


                    $('#listLabService').html(html);
