@if ($permission['show'])
    <a href="{{ route('admin.v1-question-details.index', $query->{$masterId}) }}" class="mb-1 btn btn-info btn-sm"
       title="@lang('general.question_details')">
        <i class="fa fa-list-alt"></i>
        <span class="d-none d-md-inline"> @lang('general.question_details')</span>
    </a>
